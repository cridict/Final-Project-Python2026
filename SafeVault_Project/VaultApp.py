...
def add_saved_row(site, username, pw):
    ...
    def delete_row():
        entered = simpledialog.askstring("Confirm Delete", "Enter master password to delete entry:", show="*")
        if entered == master_password:
...
tk.Label(app, text="SECURE ACCESS PORTAL", bg="#1e3a5f", fg="white", width=50, pady=12).pack(fill="x")
